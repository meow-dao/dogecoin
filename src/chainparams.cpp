...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Meow v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Meow values
        ...
        vSeeds.push_back(CDNSSeedData("multimeow.org", "seed.multimeow.org", true));
        vSeeds.push_back(CDNSSeedData("multimeow.org", "seed2.multimeow.org"));
